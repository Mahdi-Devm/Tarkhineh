...
import { Category, Product, SubCategory } from '../constants/type-menu/type'
...
const getLikedProduct = async (Token: string): Promise<Product[]> => {
                ...
                >
                  ...
                  <div className="mt-4 flex w-full flex-col sm:mr-4 sm:w-2/3 sm:pl-4">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {likes.data?.some((item) => item.id === product.id) ? (
                          <CiHeart
                    ...
                    <div className="mt-5 mb-6 flex items-center justify-center gap-1">
                      ...
                      {isProductInCart(Number(product.id)) && (
                        <button
