...
function BodyBranchpage() {
  ...
  return (
    <>
      <h1 className="mt-5 text-right text-2xl font-semibold">پیشنهاد ویژه</h1>
      ...
      <div className="h-[455px] w-[1400px] bg-[#315F41]">
        <h1 className="mt-5 text-right text-2xl font-semibold">غذاهای محبوب</h1>
        <div className="relative mx-auto w-[1300px] max-w-full p-5">
          <div className="overflow-hidden">
            <div
              id="product-slider-2"
