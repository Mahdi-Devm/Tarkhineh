...
const Populardishes: React.FC<PopulardishesProps> = ({ data, isLoading }) => {
  ...
  return (
    <section className="mx-auto my-10 flex w-full flex-col items-center justify-center">
      ...
      <div className="mx-auto w-full rounded-2xl bg-[#417F56] p-10">
        <div className="flex justify-end">
          <h1 className="mr-8 mb-4 border-b-1 border-[#6c6969] py-2 text-right text-2xl font-semibold text-[#ffffff]">
            غذای ایرانی
          </h1>
        </div>
