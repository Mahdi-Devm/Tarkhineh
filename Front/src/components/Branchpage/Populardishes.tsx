...
const Populardishes: React.FC<PopulardishesProps> = ({ data, isLoading }) => {
  ...
  return (
    <div className="h-auto w-92 max-w-[1400px] rounded-2xl bg-[#315F41] p-5 sm:w-[90%] md:w-[80%] lg:w-[100%]">
      <div className="mx-auto w-full rounded-2xl">
        <div className="flex justify-end">
          <h1 className="mr-8 mb-4 border-b-1 border-[#417F56] py-2 text-right text-2xl font-semibold text-[#f9f9f9]">
            غذای ایرانی
          </h1>
        </div>

        <div className="relative mx-auto w-full max-w-full px-2">
          {isLoading ? (
