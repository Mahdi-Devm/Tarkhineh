...
function Footer() {
  return (
    <div
      className="relative w-full bg-cover bg-center px-10 py-0 text-white sm:px-15 sm:py-4"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-screen-xl flex-col gap-10 md:flex-row">
...
>>>>>>> a87dd8c8db77652b77ea09c91033b978ca22023a
      <ToastContainer />
    </div>
  )
}
